...
from jwt_auth.exceptions import InvalidToken, JwtAuthFailed
from jwt_auth.models import UserToken
from jwt_auth.tokens import Token


User = TypeVar("User", AbstractBaseUser, UserToken)
...
class JwtAuthBackend:
    ...
    def authenticate(self, request=None, **kwargs):
        if request is None or hasattr(request, "__jwt_auth__"):
            return None
